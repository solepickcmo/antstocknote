    ...
    <div className="calculator-page animate-fade-in">
      ...
      <div className="calculator-grid">
        ...
        <div className="calc-card">
          ...
          {selectedHolding && (
            <div className="sim-holding-info watering-row-container">
          ...
          <div className="calc-info watering-row-container" style={{ marginTop: '1.5rem' }}>
            <h4>💡 물타기 전략 주의사항</h4>
            <ul>
        ...
        <div className="calc-result-section">
          {!selectedHolding ? (
            <div className="result-card sim-placeholder apple-glass">
              <TrendingDown size={32} color="var(--text-secondary)" />
            ...
            <>
              ...
              {waterfallResult && waterfallResult.newAvgPrice && (
                <>
                  <div className="result-card highlight-card">
                    ...
                    <div className="return-required" style={{ color: 'var(--text-secondary)' }}>
                      기존 {Math.floor(selectedHolding.avgPrice).toLocaleString()}원 →{' '}
                      <span className="profit-text" style={{ fontWeight: 700 }}>
                  ...
                  <div className="result-sub-grid">
                    <div className="result-card">
                      ...
                      <div className="value-group small">
                        <span className="val" style={{ fontSize: '1.75rem' }}>{waterfallResult.newTotalQty}</span>
                    ...
                    <div className="result-card">
                      ...
                      <div className="value-group small">
                        <span className="val loss-text" style={{ fontSize: '1.75rem' }}>{(waterfallResult.additionalInvestment ?? 0).toLocaleString()}</span>
                        <span className="unit">원</span>
                      </div>
                    </div>
                  </div>
              ...
              {!waterfallResult?.newAvgPrice && (
                <div className="result-card apple-glass sim-placeholder">
                  <p className="text-secondary">추가 매수 단가와 수량을 입력하면<br/>물타기 시뮬레이션 결과가 나타납니다.</p>
                </div>
              )}
            </>
          )}
